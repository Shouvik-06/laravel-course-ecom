...
@section('body')
    <div class="page-header">
        <div>
            <h1 class="page-title">Update Unit</h1>
        </div>
                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{route('unit.update', ['id' => $unit->id])}}" method="POST">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" name="name" id="firstName" placeholder="Enter unit name" type="text" value="{{$unit->name}}">
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label for="firstName" class="col-md-3 form-label">Unit Code</label>
                            <div class="col-md-9">
                                <input class="form-control" name="code" id="firstName" placeholder="Enter code" type="text" value="{{$unit->code}}">
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label for="lastName" class="col-md-3 form-label">Unit Description</label>
                            <div class="col-md-9">
                                <textarea class="form-control" name="description" id="lastName" placeholder="Enter description" type="text">{{$unit->description}}</textarea>
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                ...
                                <label><input  name="status" type="radio" value="0" {{$unit->status != 1 ? 'checked' : ''}}> Unpublished</label>
                            </div>
                        </div>

                ...
                <div class="main-sidemenu">
                    ...
                    <ul class="side-menu">
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                <li><a href="#" class="slide-item">Manage Orders</a></li>
                            </ul>
                        </li>
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="#">
...
<script>
    ...
    //     let response = await fetch("{{url('/get-sub-category-by-category?')}}" + new URLSearchParams({'id': categoryID}));
    ...
    //     window.onload = () => {
    //         getSubCategoryByCategory(document.getElementById("Category").value);
    //     };
    // };
</script>
